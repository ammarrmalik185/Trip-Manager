...
function TripList({navigation}: any): React.JSX.Element {
    ...
    return (
        <SafeAreaView style={styles.main}>
            {/*<PopupModal state={false}*/}
            {/*            modalData={new ModalData(ModalType.PickAButton, "Are you sure you want to delete this trip?", (confirm: any) => {*/}
            {/*                if (confirm) {*/}
            {/*                    // Delete the trip*/}
            {/*                }*/}
            {/*            }, ["Test 1", "Test 2", "Test 3", "Test 4", "Test 3", "Test 4", "Test 3", "Test 4", "Test 3", "Test 4", "Test 3", "Test 4"], "")}/>*/}
            {trips.length !== 0 &&
                <FlatList
            ...
            <TouchableOpacity activeOpacity={0.5} style={styles.fab} onPress={() => {
                navigation.navigate(pages.TripCreate)
            }}>
