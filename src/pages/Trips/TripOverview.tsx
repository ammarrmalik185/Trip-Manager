    ...
    return (
        <View style={styles.main}>
            <PopupModal state={modalVisible}
                        modalData={new ModalData(SettingsManager.settings.hardConfirmationForDeleteTrip ? ModalType.HardConfirmation : ModalType.SoftConfirmation, "Are you sure you want to delete this trip?", (confirm: any) => {
                            if (confirm) {
            ...
            <View style={styles.bottom}>
                <View style={{...styles.horizontalStack, marginHorizontal: 40}}>
                    <TouchableOpacity onPress={() => {
                        navigation.navigate(pages.TripEdit, {trip: route.params.trip})
                ...
                <View style={styles.horizontalStack}>
                    <TouchableOpacity style={styles.iconTextGroup}
                                      onPress={() => navigation.navigate(pages.TripMembers, {trip: route.params.trip})}>
                        <Image
                    ...
                    <TouchableOpacity style={styles.iconTextGroup}
                                      onPress={() => navigation.navigate(pages.TripLogs, {trip: route.params.trip})}>
                        <Image
                    ...
                    <TouchableOpacity style={styles.iconTextGroup}
                                      onPress={() => navigation.navigate(pages.TripExpenses, {trip: route.params.trip})}>
                        <Image
                            source={require('../../images/uiImages/Money.png')}
                            style={styles.icon}
                        />
                        <Text
                            style={styles.iconText}>{SettingsManager.settings.currencySymbol} {route.params.trip.expenses.reduce((acc: any, expense: any) => acc + expense.amount, 0)}</Text>
                        <TouchableOpacity onPress={() => {
