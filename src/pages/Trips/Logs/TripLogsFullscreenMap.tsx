...
export default function TripLogsFullscreenMap({route, navigation}: any) {
    ...
    useEffect(() => {
        Geolocation.getCurrentPosition(position => {
            ...
            setCenterLocation(mapMarkers.length > 0 ? mapMarkers[mapMarkers.length - 1].position : ownLocation || {
                lat: 0,
                lng: 0
            });
        ...
        <View style={{flex: 1}}>
            <LeafletView
                ...
                ownPositionMarker={{
                    ...
                    icon: '🔵',
                    size: [15, 15],
                    animation: {type: AnimationType.FADE, iterationCount: 1} as MapMarkerAnimation
                }}
