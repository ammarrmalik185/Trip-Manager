            ...
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => <TripExpenseAmountListItem item={item} onClick={() => {
                        navigation.navigate(Pages.TripExpensesCustomList, {
                            trip: route.params.trip,
                            customList: route.params.trip.expenses.filter((exp: expense) => exp.category == item.member.name)
                        })
                    }}/>}
                />
            </View>
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => <TripMemberAmountListItem item={item} onClick={() => {
                        navigation.navigate(Pages.TripExpensesCustomList, {
                            trip: route.params.trip,
                            customList: route.params.trip.expenses.filter((exp: expense) => exp.payers.find(p => p.member.id == item.member.id))
                        })
                    }}/>}
                />
            </View>
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => <TripMemberAmountListItem item={item} onClick={() => {
                        navigation.navigate(Pages.TripExpensesCustomList, {
                            trip: route.params.trip,
                            customList: route.params.trip.expenses.filter((exp: expense) => exp.getCalculatedExpense().spenders.find(p => p.member.id == item.member.id))
                        })
                    }}/>}
                />
            </View>
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => <TripMemberAmountListItem item={item} onClick={() => {
                        navigation.navigate(Pages.TripExpensesCustomList, {
                            trip: route.params.trip,
                            customList: route.params.trip.expenses.filter((exp: expense) => exp.payers.find(p => p.member.id == item.member.id) || exp.getCalculatedExpense().spenders.find(p => p.member.id == item.member.id))
                        })
                    }}/>}
                />
            </View>
