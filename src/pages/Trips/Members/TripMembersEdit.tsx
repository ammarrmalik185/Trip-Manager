...
export default function TripMembersEdit({route, navigation}: any) {
    ...
    return (
        <View style={styles.main}>
            ...
            <TextInput placeholderTextColor={palette.placeholder} style={styles.inputField} value={name}
                       onChangeText={setName}/>

            <Text style={styles.inputLabel}>Description</Text>
            <TextInput placeholderTextColor={palette.placeholder} style={styles.inputFieldMultiLine} value={description}
                       onChangeText={setDescription} multiline={true}/>

            <Text style={styles.inputLabel}>Email</Text>
            <TextInput placeholderTextColor={palette.placeholder} style={styles.inputField} value={email}
                       onChangeText={setEmail}/>

            <Text style={styles.inputLabel}>Phone</Text>
            <TextInput placeholderTextColor={palette.placeholder} style={styles.inputField} value={phone}
