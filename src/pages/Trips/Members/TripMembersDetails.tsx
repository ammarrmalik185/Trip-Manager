    ...
    return (
        <View style={styles.main}>
            ...
            <PopupModal state={modalVisible}
                        modalData={new ModalData(ModalType.SoftConfirmation, "Are you sure you want to delete this member?", (confirm: boolean) => {
                            if (confirm) {
            ...
            <View style={styles.bottom}>
                ...
                <View style={{marginBottom: 30}}>
                    <View style={styles.memberNeutralSide}>
                        ...
                        <Text
                            style={total > 0 ? styles.memberNeutralSideTextGreen : styles.memberNeutralSideTextRed}>{SettingsManager.settings.currencySymbol} {total}</Text>
                    </View>
                ...
                <View style={{...styles.horizontalStack, marginHorizontal: 40}}>
                    <TouchableOpacity onPress={() => {
                        navigation.navigate(pages.TripMembersEdit, {
