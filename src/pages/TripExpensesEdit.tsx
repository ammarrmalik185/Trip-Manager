...
export default function TripExpensesEdit({route} : any){
    const [newExpense, setNewExpense] = useState(route.params.expense);
    const [oldExpense, setOldExpense] = useState(new expense());


    return <ScrollView style={styles.main}>
        <View style={styles.inputSection}>
            <Text style={styles.inputLabel}>Title</Text>
            <TextInput style={styles.inputField} placeholder={"Enter Expense Title"} value={newExpense.title} onChangeText={txt => newExpense.title = txt}/>
        </View>
        <View style={styles.inputSection}>
            <Text style={styles.inputLabel}>Category</Text>
            <TextInput style={styles.inputField} placeholder={"Enter Expense Catagory"} value={newExpense.category} onChangeText={txt => newExpense.category = txt}/>
        </View>
        <View style={styles.inputSection}>
            <Text style={styles.inputLabel}>Description</Text>
            <TextInput style={styles.inputField} placeholder={"Enter Description"} value={newExpense.description} onChangeText={txt => newExpense.description = txt}/>
        </View>
        <View style={styles.inputSection}>
